...
### 2. view_file affected files (1–2 calls)

view_file the specific files and line ranges where the error occurs. Focus on the exact location — do not read entire files.

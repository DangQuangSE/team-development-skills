...
Use the view_file tool to read EVERY artifact from EVERY preceding phase:
...
9. Use list_dir: `projects/{slug}/team/techlead/ADR-*.md` → read all ADRs found
...
**BE Dev phase:**
13. Use list_dir: `projects/{slug}/team/be/**/*` → read all source files
14. `projects/{slug}/team/be/.env.example`
15. `projects/{slug}/team/be/pr-description.md`

**FE Dev phase:**
16. Use list_dir: `projects/{slug}/team/fe/**/*` → read all source files
...
24. Use list_dir: `projects/{slug}/validation-errors/*.md` → read any validation error logs
...
write_to_file all 3 files completely. No placeholders.
...
After writing all 3 files, use the view_file tool to re-read each. Check ALL required headings (case-sensitive):
...
- **Attempt 3:** HARD STOP. write_to_file:

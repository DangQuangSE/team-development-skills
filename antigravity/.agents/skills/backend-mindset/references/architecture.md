...
Separate read and write models when read/write patterns diverge significantly. write_to_file side: normalized, command-driven, optimized for consistency. view_file side: denormalized projections, optimized for query shape.

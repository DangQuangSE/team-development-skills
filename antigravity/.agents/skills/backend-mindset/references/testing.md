...
1. **RED**: write_to_file a failing test describing desired behavior
2. **GREEN**: write_to_file the minimum code to make it pass — nothing more
...
| Wrong | Right |
|-------|-------|
| write_to_file implementation first | Tests first — RED before GREEN |

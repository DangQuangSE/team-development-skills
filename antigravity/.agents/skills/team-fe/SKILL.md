...
## Step 4 — write_to_file Frontend Source Files

write_to_file actual implementation files to `projects/{slug}/team/fe/`.
...
## Step 5 — write_to_file `pr-description.md`

write_to_file `projects/{slug}/team/fe/pr-description.md`:
...
After writing all files, use the view_file tool to re-read `pr-description.md`. Check required headings (case-sensitive):

...
## Step 0.5 — write_to_file Project Configuration
...
- Use list_dir: `projects/{slug}/team/qa/sign-off.md`
...
Use the view_file tool: `projects/{slug}/team/pm/task-breakdown.md`
...
Use the view_file tool: `projects/{slug}/flags-summary.md`
...
view_file `projects/{slug}/team/qa/sign-off.md` and extract the Verdict line.

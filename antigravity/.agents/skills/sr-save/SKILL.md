...
```
ask_question: "Which project to save context for? (slug)"
```

view_file all available files in `projects/{slug}/`.
...
## Step 1 — write_to_file Context Files

write_to_file all files under `projects/{slug}/_context/`:

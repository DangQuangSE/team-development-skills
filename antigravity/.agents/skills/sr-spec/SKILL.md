...
```
ask_question: "Which project to write spec for? (slug name or path to brainstorm.md)"
```
...
## Step 1 — write_to_file spec.md

write_to_file `projects/{slug}/spec.md`. No word limit. Every sub-section fully written.

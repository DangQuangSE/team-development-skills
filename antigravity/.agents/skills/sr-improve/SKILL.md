...
```
ask_question: "Which project? (slug)"
```

view_file from `projects/{slug}/`:
...
## Step 1 — write_to_file improvement-report.md

write_to_file `projects/{slug}/improvement-report.md`. No word limit.

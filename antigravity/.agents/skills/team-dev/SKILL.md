...
Use the view_file tool to read ALL relevant artifacts:
...
## Step 4 — write_to_file Backend Source Files

write_to_file actual implementation files to `projects/{slug}/team/be/`.
...
write_to_file ALL of the following:
...
## Step 5 — write_to_file `.env.example`

write_to_file `projects/{slug}/team/be/.env.example`:
...
## Step 6 — write_to_file `pr-description.md`

write_to_file `projects/{slug}/team/be/pr-description.md`:
...
After writing all files, use the view_file tool to re-read:

...
```
ask_question: "Which project to generate SRS for? (slug)"
```
...
Create files under `projects/{slug}/srs/`. write_to_file each file completely before
...
write_to_file `projects/{slug}/srs/00-master-index.md`:

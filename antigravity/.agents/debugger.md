...
tools: ["view_file", "grep_search", "list_dir", "run_command", "replace_file_content"]
model: sonnet
---
...
replace_file_content only the file(s) at the confirmed root cause location. Do not touch unrelated code.

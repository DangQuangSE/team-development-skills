...
view_file `CLAUDE.md` (if present) for project conventions.
view_file each changed file **in full**.
...
1. view_file `CLAUDE.md` for project constraints
2. Parse PR description for goals and linked issues
3. view_file each changed file in full
